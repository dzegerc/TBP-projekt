  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        {adresa && (
          <>
            <p>Ulica: {adresa.split(',')[0].trim()}</p>
            <p>Broj: {adresa.split(',')[1].trim()}</p>
            <p>Grad: {adresa.split(',')[2].trim()}</p>
            <p>Država: {adresa.split(',')[3].trim()}</p>
            <p>Poštanski broj: {adresa.split(',')[4].trim()}</p>
          </>
        )}
